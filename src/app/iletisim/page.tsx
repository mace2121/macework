                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-5 group">
                            ...
                            <div className="flex flex-col">
                                ...
                                <a href={`tel:${siteContent.contact.phone}`} className="text-base font-bold hover:text-macework transition-colors">{siteContent.contact.phone}</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-5 group">
                            ...
                            <div className="flex flex-col">
                                ...
                                <a href={`mailto:${siteContent.contact.email}`} className="text-base font-bold hover:text-macework transition-colors">{siteContent.contact.email}</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-5 group">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-sm font-medium text-zinc-300 leading-relaxed whitespace-pre-line">{siteContent.contact.address}</span>
                            </div>
                        </div>
                    </div>
                </div>
